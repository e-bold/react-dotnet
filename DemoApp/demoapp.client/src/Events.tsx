...
const containerStyle: CSSProperties = {
    width: "100%",
    height: "80vh", // Increase height (adjust as needed)
    minHeight: "500px", // Ensures a minimum size
...
export const Events: FC<{ style?: CSSProperties }> = ({ style }) => {
  return (
    <SigmaContainer style={containerStyle} settings={sigmaSettings} graph={MultiDirectedGraph}>
